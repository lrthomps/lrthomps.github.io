...
Bouldering more and more (regularly getting up to ~V3-V5; also finding harder and harder V2s). Ran a 1:43:47 half but proceeded to tweak a glute the next week.
:::
:::
::: {.row}
::: {.timespan} 
...
Bouldering loads; ran the Enchantments in-a-day (many hours); ran a semi-fast 10km (48:20).
:::
:::
::: {.row}
::: {.timespan} 
